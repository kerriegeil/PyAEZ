...
def EtaCalc(Tx365, Ta365, Pcp365, Txsnm, Fsnm, Eto365, wb_old, sb_old, doy, istart0, istart1, Sa, D, p, kc_list, lgpt5_point):
    ...
    if Tx365 <= Txsnm and Ta365 <= 0.:
        ...
        # wb, wx, Eta = eta(wb_old, etm-sbx, Sa, D, p, Pcp365)
        # Eta=Eta+sbx
    ...
    #             kc = kc_list[3]*(1.-xx)+(kc_list[4]*xx) # kc0 and kc5 in fortran, which are these????
    #         elif doy < istart0:
    ...
    return Eta365, Etm365, Wb365, Wx365, Sb365, kc365, eta_class,snm
