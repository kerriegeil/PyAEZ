...
import BioMassCalc_2023OCT17 as BioMassCalc
import CropWatCalc_2023OCT17 as CropWatCalc
import ThermalScreening_2023OCT17 as ThermalScreening
import os
import sys
...
class CropSimulation(object):
    ...
    setParallel=clim_reg.setParallel
    ...
    def getLGP(self, Sa=100., D=1.):
        ...
        if self.parallel:
            ...
            # if module 1 delete pet_daily here to save RAM
            # this code is copy/pasted to module 2, but we don't want to delete it there
            if os.path.basename(__file__)=='ClimateRegime.py':
