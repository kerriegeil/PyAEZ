...
class UtilitiesCalc(object):
    ...
    def generateLatitudeMap(self, lat_min, lat_max, im_height, im_width):
        ...
        """        
        lat_lim = np.linspace(lat_min, lat_max, im_height,dtype='float32')
        lon_lim = np.linspace(1, 1, im_width,dtype='float32') # just temporary lon values, will not affect output of this function.
