...
New Modification (Modified by Swun Wunna Htet & Kittiphon Boonma)
...
class ClimaticConstraints(object):
    ...
    # def WetnessIndicator(self, lgp, lgp_equiv):
    #     """
    #     This function calculates the wetness indicator.

    #     Parameters
    #     ----------
    #     lgp : 2-D numpy array
    #         Length of Growing Period.
    #     lgp_equiv : 2-D numpy array
