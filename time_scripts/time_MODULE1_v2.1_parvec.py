# Author: K. Geil
# Date: 09/2023
# Description: get compute time for all functions in pyaez module 1 version parvec
...
v_folder = r'pyaez2.1/pyaez2.1_parvec/'     # path to the correct version directory
out_path = work_dir+'time_scripts/results/' # path for saving output data (computational time for each function)
# china
...
# # global
# data_dir = r'C://Users/kerrie/Documents/02_LocalData/pyAEZ_input_data/global_NOTPRODUCTION/npy/'   # path to your climate data
...
# elevfile = r'C://Users/kerrie/Documents/02_LocalData/pyAEZ_input_data/global_NOTPRODUCTION/tif/Elevation_2268708_5m.tif'  # subset for no antarctica, 1800 lats
# soilfile = r'C://Users/kerrie/Documents/02_LocalData/pyAEZ_input_data/global_NOTPRODUCTION/tif/soil_terrain_lulc_global_08333.tif'  # subset for no antarctica, 1800 lats
...
# out_path = work_dir+'time_scripts/results/' # path for saving output data (computational time for each function)
# # china
# data_dir = r'C://Users/kerrie.WIN/Documents/data/pyAEZ_data_inputs_china_03272023/npy/' # path to your climate data
...
# elevfile = r'C://Users/kerrie.WIN/Documents/data/pyAEZ_data_inputs_global_NOTPRODUCTION/tif/Elevation_2268708_5m.tif' # subset for no antarctica, 1800 lats
# soilfile = r'C://Users/kerrie.WIN/Documents/data/pyAEZ_data_inputs_global_NOTPRODUCTION/tif/soil_terrain_lulc_global_08333.tif' # subset for no antarctica, 1800 lats

#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# enter personal and system info for output filename
domain='china'#'global'# description of the input data domain
person='KLG' # your initials
location='home' #'SSC' # nickname for your location
computer='Windows10'  # operating system
processor='IntelCorei7-12800H' #IntelZeonW2225' # 'bigmem' # name of your computer chip/processor
ram='32GB' # how much RAM your machine has
test_tag='v2.1_parvec'#'v2.1_parvecnp' # # short description of which code version is being timed
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
